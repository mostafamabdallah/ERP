...
const en: Translations = {
  ...
  employees: {
    ...
    editedSuccess: "Employee updated successfully",
    active: "Active",
    inactive: "Inactive",
    setActive: "Set Active",
    setInactive: "Set Inactive",
    statusChangedActive: "Employee activated",
    statusChangedInactive: "Employee deactivated",
  ...
  financial: {
    pageTitle: "Profitability Dashboard",
    breakEvenChart: "Cumulative Revenue vs Costs",
    cumulativeRevenue: "Cumulative Revenue",
    projectedRevenue: "Projected Revenue",
    cumulativeCosts: "Cumulative Costs",
    dailyBreakdown: "Daily Revenue vs Cost",
    costBreakdown: "Cost Breakdown",
    employeeCosts: "Employee Cost Summary",
    totalRevenue: "Total Revenue",
    totalCosts: "Total Costs",
    netProfit: "Net Profit / Loss",
    breakEvenDay: "Break-even Day",
    projectedMonthRevenue: "Projected Month Revenue",
    ...
    profitZone: "In Profit Zone",
    lossZone: "In Loss Zone",
    basedOnAvg: "Based on current daily average",
  },
};
